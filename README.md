...
- [ai-delivery-spec](https://github.com/franklinxkk/ai-delivery-spec) - AI原生软件交付框架，支持从原型自动生成完整PRD。交互总账（12x压缩）、FRR补全门禁（16节强制校验）、三工作路径（传统PM/AI原生/AI编程交付）。含CRM、交通、教育、医疗4个领域模块。
...
- [OpenHuman](https://github.com/tinyhumansai/openhuman) - 隐私优先的桌面 AI Agent，Memory Tree 记忆系统，118+ 服务一键连接，Rust 编写本地运行。
- [ds4](https://github.com/antirez/ds4) - Redis 之父 antirez 的新作，MacBook 本地跑 DeepSeek V4 Flash 的推理引擎。
- [Hermes Agent](https://github.com/NousResearch/hermes-agent) - 越用越聪明的 AI Agent，持续学习和进化。
- [Symphony](https://github.com/openai/symphony) - OpenAI 出品的 Agent 协作框架。
- [GenericAgent](https://github.com/lsdefine/GenericAgent) - 自进化 Agent，Token 消耗降低 6 倍。
...
- [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) - 给 AI 编程助手装上设计品味的技能插件，告别模板化 UI，支持 Cursor/Claude Code/Codex 等主流工具，39k+ Star。
...
- [mattpocock/skills](https://github.com/mattpocock/skills) - TypeScript 大佬 Matt Pocock 开源的 AI Coding 实战 Skills，教你用 AI 写出工程级代码。
- [agent-skills](https://github.com/addyosmani/agent-skills) - Chrome 团队 Addy Osmani 出品的 AI 编程 Agent 生产级工程技能包。
- [spec-kit](https://github.com/github/spec-kit) - GitHub 官方推出的规格驱动开发工具包。
- [scientific-agent-skills](https://github.com/K-Dense-AI/scientific-agent-skills) - 覆盖科研、金融、写作场景的 Agent Skills 合集。
- [everything-claude-code](https://github.com/affaan-m/everything-claude-code) - Claude Code 性能优化全家桶。
- [dictionary-of-ai-coding](https://github.com/mattpocock/dictionary-of-ai-coding) - AI Coding 术语大白话词典，把行话翻译成人话。
- [claude-howto](https://github.com/luongnv89/claude-howto) - Claude Code 快速上手教程。
- [andrej-karpathy-skills](https://github.com/forrestchang/andrej-karpathy-skills) - Karpathy 风格 AI 编程规范。
- [agentmemory](https://github.com/rohitg00/agentmemory) - AI 编码 Agent 的持久化记忆方案，基于真实 benchmark。
...
- [OpenChatBI](https://github.com/zhongyu09/openchatbi) - 基于大语言模型的智能数据分析 Agent，用自然语言直接查询、分析和生成报告，集成 LangGraph 和 LangChain 实现 Text2SQL 和数据分析自动化。
...
- [Mano-P](https://github.com/Mininglamp-AI/Mano-P) - 面向端侧设备的 GUI Agent 模型，纯视觉方式理解和操作图形界面，可在 Mac 本地跑。
- [Cider](https://github.com/Mininglamp-AI/cider) - Apple Silicon 上的 MLX 模型推理加速框架，支持 W8A8 量化加速。
- [OpenMythos](https://github.com/kyegomez/OpenMythos) - 用纯 PyTorch 复现的循环深度 Transformer 架构，推测 Claude Mythos 未公开的架构。
- [DeepSeek-TUI](https://github.com/Hmbown/DeepSeek-TUI) - Rust 写的终端原生 AI 编程 Agent，专门对接 DeepSeek V4，相当于 DeepSeek 版 Claude Code。
- [Pixelle-Video](https://github.com/AIDC-AI/Pixelle-Video) - 阿里开源的全自动短视频引擎，一条龙生成视频。
...
- [agents-cli](https://github.com/google/agents-cli) - Google 官方 Agent CLI。
- [Dexter](https://github.com/virattt/dexter) - 自主金融研究 Agent。
- [TradingAgents](https://github.com/TauricResearch/TradingAgents) - 多 Agent 金融交易框架。
- [AI-Trader](https://github.com/HKUDS/AI-Trader) - 港大出品 100% 全自动 AI 交易平台。
- [Kronos](https://github.com/shiyu-coder/Kronos) - 专为金融市场语言设计的基础大模型。
- [omlx](https://github.com/jundot/omlx) - Apple Silicon 本地 LLM 推理服务器。
- [Warp](https://github.com/warpdotdev/warp) - Agentic 开发环境终端，狂揽 4.6 万 Star。
- [CodexPlusPlus](https://github.com/BigPizzaV3/CodexPlusPlus) - Codex 增强工具，解锁插件和会话删除。
- [jcode](https://github.com/1jehuang/jcode) - Rust 写的极简 Coding Agent 外壳，内存占用极低。
- [9router](https://github.com/decolua/9router) - 免费白嫖 AI Coding 的路由器，一键接入 40+ 模型。
- [Telegraf](https://github.com/influxdata/telegraf) - 万物皆可采集的指标 Agent，Go 语言编写，插件丰富。
- [Supervision](https://github.com/roboflow/supervision) - 可复用的计算机视觉工具库，检测、分割、标注全流程覆盖。
- [Supertonic](https://github.com/supertone-inc/supertonic) - 基于ONNX的本地多语言TTS引擎，Swift开发，速度极快。
...
- [MrRSS](https://github.com/WCY-dt/MrRSS) - 国产桌面端 AI RSS 阅读器，主打翻译和摘要。
...
- [Maigret](https://github.com/soxoj/maigret) - 输入一个用户名，自动在 3000+ 网站搜索公开信息并汇总成数字档案。
...
- [RuView](https://github.com/ruvnet/RuView) - 用 WiFi 信号做空间感知，不需要摄像头即可监测生命体征和人体存在。
- [scrcpy](https://github.com/Genymobile/scrcpy) - 老牌开源安卓投屏控制工具，延迟极低，14 万 Star。
- [CloakBrowser](https://github.com/CloakHQ/CloakBrowser) - 基于 Chromium 源码级修改的隐身浏览器，反检测 30/30 全过。
...
- [GreenWall](https://github.com/zmrlft/GreenWall) - 在你的 GitHub 贡献历史墙上画画，鼠标涂鸦一键生成，程序员的专属浪漫。
...
- [illa-helper](https://github.com/xiao-zaiyi/illa-helper) - 浸入式学语言助手，浏览器插件通过 AI 智能将网页词语替换为目标语言词汇，支持 20+ 语言、音标显示、双 TTS 语音合成和交互式悬浮框。
- [Ech0](https://github.com/lin-snow/Ech0) - 面向个人的轻量级联邦发布平台，支持 ActivityPub 协议，内存占用不到 15MB，支持 RSS 订阅、零干扰 Markdown 写作和一键备份恢复。
- [vRain](https://github.com/shanleiguang/vRain) - 中文古籍刻本风格直排电子书制作工具，以刻本形式之美复刻经典，支持诗经、楚辞、史记等古籍，带来沉浸式优雅阅读体验。
- [WhatCable](https://github.com/darrylmorley/whatcable) - macOS 菜单栏工具，用大白话告诉你 USB-C 线到底能干啥。
- [MicYou](https://github.com/LanRhyme/MicYou) - 把 Android 旧手机变成电脑的无线麦克风。
- [animal-island-ui](https://github.com/guokaigdg/animal-island-ui) - 动物森友会风格的 React UI 组件库。
- [OrcaSlicer-bambulab](https://github.com/FULU-Foundation/OrcaSlicer-bambulab) - Bambu Lab 3D 打印切片器定制版，3 天 3300 Star。
- [Supersplat](https://github.com/playcanvas/supersplat) - 浏览器端 3D 高斯溅射编辑器。
- [zero-native](https://github.com/vercel-labs/zero-native) - Vercel 出品，用 Zig+Web UI 构建原生桌面和移动应用。
...
- [cell-architecture-studio](https://github.com/cclank/cell-architecture-studio) - React+Three.js 构建的交互式 3D 细胞架构可视化画廊。
...
- [Xget](https://github.com/xixu-me/xget) - 面向开发者资源的超高性能一体化加速引擎，覆盖 GitHub、npm、PyPI、Docker Hub、Hugging Face 等全场景，基于 Cloudflare Workers 边缘计算加速。
- [PDF-Craft](https://github.com/oomol-lab/pdf-craft) - 将 PDF 转成 EPUB 电子书，支持 OCR 识别扫描件文本，AI 自动构建目录和引用标注，生成 EPUB 和 Markdown 格式。
- [Nigate](https://github.com/hoochanlon/Free-NTFS-for-Mac) - 免费、轻巧的 macOS NTFS 读写工具，专为 Apple Silicon 优化，插上 NTFS 磁盘即可像普通磁盘一样拷贝编辑文件。
- [Lynx Proxy](https://github.com/suxin2017/lynx-proxy) - 基于 Rust 开发的代理抓包工具，支持 HTTP(S)/WebSocket 协议、请求拦截和脚本注入、跨平台运行，提供现代化 Web 客户端界面。
- [LiteOps](https://github.com/opsre/LiteOps) - 轻量级 DevOps 平台，聚焦 CI/CD 核心功能，简洁直观的界面设计，支持自动化构建和部署，降低使用门槛。
- [OfficeCLI](https://github.com/iOfficeAI/OfficeCLI) - 命令行直接创建、读取、修改 Word/Excel/PPT 文件，无需安装 Office。
- [SoftwareCopyright-Skill](https://github.com/Fokkyp/SoftwareCopyright-Skill) - 读取项目源码自动生成全套软著申请材料。
- [ian-handdrawn-ppt](https://github.com/helloianneo/ian-handdrawn-ppt) - 手绘风格技术解释图生成工具。
- [huashu-md-html](https://github.com/alchaincyf/huashu-md-html) - Markdown/HTML 双向转换流水线工具，内置 4 套反 AI slop 主题。
- [DocuSeal](https://github.com/docusealco/docuseal) - 开源电子签名 DocuSign 替代品。
- [KillerPDF](https://github.com/SteveTheKiller/KillerPDF) - 仅 6MB 的 PDF 编辑器。
- [ppt-master](https://github.com/hugohe3/ppt-master) - AI 文档转 PPT 工具。
- [cheat-on-content](https://github.com/XBuilderLAB/cheat-on-content) - 内容创作者的作弊器，打分-预测-复盘闭环。
- [beautiful-html-templates](https://github.com/zarazhangrui/beautiful-html-templates) - 32 套 HTML 幻灯片模板，让 AI 帮你做 PPT。
- [Mealie](https://github.com/mealie-recipes/mealie) - 开源食谱管理工具。
- [OpenReel Video](https://github.com/Augani/openreel-video) - 浏览器端视频编辑器。
- [Clawdmeter](https://github.com/HermannBjorgvin/Clawdmeter) - ESP32 桌面仪表盘，实时显示 Claude Code 使用量。
- [TokenSpeed](https://github.com/lightseekorg/tokenspeed) - NVIDIA Blackwell 上跑得最快的 LLM 推理引擎之一。
- [SystemInformer](https://github.com/winsiderss/systeminformer) - 免安装 Windows 系统监控工具。
- [MasterDnsVPN](https://github.com/masterking32/MasterDnsVPN) - 高级 DNS 隧道 VPN，抗审查利器。
- [a-stock-data](https://github.com/simonlin1212/a-stock-data) - A 股全栈数据工具包，6 层架构 15 个端点 7 个数据源。
...
- [SimpleKernel](https://github.com/Simple-XX/SimpleKernel) - 面向 AI 辅助学习的操作系统内核项目，采用 C++23 编写，支持 x86_64、RISC-V 64、AArch64 三种架构，接口即 prompt，AI 可直接根据接口生成实现。
- [dive-into-llms](https://github.com/Lordog/dive-into-llms) - 上海交大《动手学大模型》编程实践教程。
- [hello-agents](https://github.com/datawhalechina/hello-agents) - Datawhale 出品，从零开始构建智能体教程。
- [easy-vibe](https://github.com/datawhalechina/easy-vibe) - 2026 Vibe Coding 入门教程。
- [awesome-agentic-ai-zh](https://github.com/WenyuChiou/awesome-agentic-ai-zh) - AI Agent 中文学习地图，7 阶段 145 个项目。
- [yao-open-prompts](https://github.com/yaojingang/yao-open-prompts) - 91 个中文 AI 提示词按场景整理。
...
- [kbone](https://github.com/Tencent/kbone) - kbone 实现了一个适配器，在适配层里模拟出了浏览器环境，让 Web 端的代码可以不做什么改动便可运行在小程序里。
- [secguides](www.github.com/Tencent/secguide) - 面向开发人员梳理的代码安全指南，旨在梳理 API 层面的风险点并提供详实可行的安全编码方案。
- [Pixal3D](https://github.com/TencentARC/Pixal3D) - 腾讯 ARC SIGGRAPH 2026 论文，从单张图片做像素对齐 3D 生成。
...
- [g3](https://github.com/bytedance/g3) - 字节跳动开源的企业级通用正向代理解决方案，基于 Rust 异步开发，支持 HTTP/Socks5 正向代理、TLS 中间人、ICAP 安全审计、优雅重载和热升级。
